...
import 'package:wink_worker/features/job/presentation/views/service_summary.view.dart';

class AfterServiceScreen extends StatefulWidget {
  final List<Map<String, dynamic>>? additionalServices;
  const AfterServiceScreen({super.key, this.additionalServices});

  @override
  State<AfterServiceScreen> createState() => _AfterServiceScreenState();
}

class _AfterServiceScreenState extends State<AfterServiceScreen> {
